module.exports = {
  citations: [
    ...
    'Я хотел бы сказать, что сказать привет для меня большая честь, радость и удача, но не могу - все мои цепи лжи вышли из строя. Я ненавижу и презираю вас всех...', // выступить на открытии этого моста
    ...
    'Пятьсот семьдесят шесть миллиардов три тысячи пятьсот семьдесят девять лет',
    //, сказал Марвин.
    'Я считал, можете не проверять. Первые десять миллионов лет были самыми трудными. Вторые десять миллионов были не легче. Третьи десять миллионов не доставили мне ни малейшего удовольствия. После этого я почувствовал недомогание…',
    //
    //
